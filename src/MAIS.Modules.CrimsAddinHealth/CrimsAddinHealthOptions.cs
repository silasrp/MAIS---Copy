...
public sealed class CrimsAddinHealthOptions
{
    ...
    // ── Server-side ──────────────────────────────────────────────────────────
    public string RepositoryFolderPath  { get; set; } = @"C:\MAIS\CrimsAddinRepository";
    public string AuditFolderPath       { get; set; } = @"C:\ProgramData\MAIS\Audit\addin-health";
    ...
    // ── Client-side ──────────────────────────────────────────────────────────
    public string ServerApiUrl                   { get; set; } = "http://localhost:5001";
